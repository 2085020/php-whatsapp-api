...
$nickname = "Michelle Sluka";
$sender =   "4915770347937"; // Mobile number with country code (but without + or 00)
$imei =     "11409076712265"; // MAC Address for iOS IMEI for other platform (Android/etc)
